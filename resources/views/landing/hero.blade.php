<div class="flex flex-col-reverse lg:flex-row w-full h-auto lg:h-auto p-6 lg:p-[128px_64px_190px_64px] sm:pb-[300px] justify-between items-center bg-gradient-to-r from-[#F2EFFE] via-[#FBFAFF] to-[#F2EFFE] max-w-full overflow-hidden gap-12 lg:gap-[115px]">
    ...
    <div class="flex flex-col items-start gap-6 flex-1 text-center lg:text-left">
        ...
        <div>
            <p class="text-[16px] lg:text-[20px]">Making learning easier with modern tools and interactive online experiences.</p>
        </div>
    </div>
    ...
    <div class="w-full lg:w-[600px] h-auto lg:h-[463px] flex justify-center items-center">
        <img 
            src="{{ asset('images/head_mobile.png') }}" 
            alt="Landing Image" 
            class="max-w-full h-[300px] sm:hidden">
        <img 
