<header
    class="flex w-full h-[80px] px-6 lg:px-[64px] py-[24px] justify-between items-center flex-shrink-0 bg-gradient-to-b from-[rgba(255, 255, 255, 0.80)] to-[rgba(255, 255, 255, 0.80)] backdrop-blur-[25px] bg-[rgba(234, 229, 241, 0.05)]">
    {{-- Logo --}}
    ...
    <div class="hidden lg:flex items-center gap-[56px]">
        <a href="#section-id"
            class="text-[#949494] font-sora text-[16px] font-normal leading-[28px] cursor-pointer no-underline hover:text-[#03045E]">
            Home
        </a>
        <a href="#section-id"
            class="text-[#949494] font-sora text-[16px] font-normal leading-[28px] cursor-pointer no-underline hover:text-[#03045E]">
    ...
    {{-- Mobile Menu --}}
    <div id="mobile-menu"
        class="hidden absolute top-[80px] left-0 w-full bg-white shadow-lg z-50 transition-all duration-300 transform -translate-y-full opacity-0">
