        ...
        <div class="grid grid-cols-12 gap-6 lg:gap-8">
                    ...
                    <div class="p-6 text-white">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-purple-100 text-sm">Detail informasi mahasiswa</p>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-md border border-gray-100 overflow-hidden mb-6">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-start gap-6 mb-8">
                            @if ($mahasiswa->foto)
                                <img src="{{ asset($mahasiswa->foto) }}" alt="Foto {{ $mahasiswa->nama }}"
                            ...
                            <div class="flex-1">
                                <h3 class="text-2xl font-bold text-gray-900 mb-2">{{ $mahasiswa->nama }}</h3>
                                ...
                                <p class="text-gray-600">Mahasiswa aktif di sistem manajemen prestasi</p>
                            </div>
                        </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div class="bg-white rounded-lg p-4 border border-gray-200">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p class="text-xs text-gray-500 font-medium">NIM</p>
            ...
            <div class="col-span-12 lg:col-span-4">
                ...
                <div
                    ...
                    <div class="p-6">
                        <div class="space-y-3">
                            <a href="{{ url("admin/users/mahasiswa/{$mahasiswa->id}/update") }}"
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Update informasi mahasiswa</p>
                                </div>
                            </a>
                    ...
                    <div class="p-5">
                        <div class="space-y-4 text-sm">
                            <div class="bg-blue-50 border-l-4 border-blue-400 p-3 rounded-r">
                                <h5 class="font-medium text-blue-800 mb-1">Role Mahasiswa</h5>
                                <p class="text-blue-700">Mahasiswa dapat mengajukan prestasi dan lomba melalui sistem
                                    ini.</p>
                            </div>
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <ul class="text-gray-600 text-xs mt-1 space-y-1">
                                        <li>• Mengajukan prestasi baru</li>
                                        <li>• Mengusulkan informasi lomba</li>
