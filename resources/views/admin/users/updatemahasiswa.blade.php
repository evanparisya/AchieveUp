...
@section('content')
    <div class="container mx-auto p-6">
        <div class="max-w-5xl mx-auto bg-white shadow-md rounded-lg p-6">
            ...
            <form action="{{ url('admin/users/mahasiswa/' . $mahasiswa->id . '/update') }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="flex flex-col items-center space-y-4">
                        ...
                        <div
                            ...
                            @if ($mahasiswa->foto)
                                <img src="{{ asset($mahasiswa->foto) }}" alt="Foto Saat Ini"
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="username" id="username"
                                value="{{ old('username', $mahasiswa->username) }}" class="input">
                            @error('username')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email"
                                value="{{ old('email', $mahasiswa->email) }}" class="input">
                            @error('email')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="program_studi_id" class="block text-sm font-medium text-gray-700 mb-1">Program
                                Studi</label>
                            <div class="relative">
