...
<<<<<<< HEAD
    ...
    <div class="flex items-center space-x-3 justify-end relative">
        <div class="flex flex-col text-right leading-tight">
            <span class="text-sm font-medium text-gray-800">{{ Auth::guard('dosen')->user()->nama ?? 'Nama Pengguna' }}</span>
                ...
                <div class="px-4 py-3 border-b">
                    <div class="flex items-center gap-3 mb-2">
                        <img
                            ...
                            @click="open = !open">
                        <div>
                            <div class="font-semibold text-md text-gray-800 truncate">{{ Auth::guard('dosen')->user()->nama ?? '-' }}</div>
                            <div class="text-xs text-gray-500 truncate">{{ Auth::guard('dosen')->user()->email ?? '-' }}</div>
                        </div>
                    </div>
                </div>
...
>>>>>>> fd04ae62bb7947e2c48d55d6652b9bccd5a09c38
