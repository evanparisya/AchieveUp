        ...
        <div class="bg-white border-t border-l border-r border-gray-200 px-6 py-4">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex items-center gap-3 w-full md:w-auto">
                    ...
                    <a href="{{ route('admin.bidang.create') }}" id="btn-add-bidang"
        ...
        <div class="overflow-hidden bg-white shadow-md border border-gray-200 rounded-b-lg">
            ...
            <div class="px-6 py-4 border-t border-gray-200">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    <p id="bidang_info" class="text-sm text-gray-600"></p>
                    <div id="bidang_pagination" class="flex flex-wrap gap-2"></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                function actionButtonsBidang(id) {
                    return `
                    <div class="flex items-center space-x-3">
                        <a href="/admin/bidang/${id}" class="action-btn text-blue-600 hover:text-blue-800" title="Detail">
                            <i class="fas fa-eye"></i>
                        </a>
                        <a href="/admin/bidang/edit/${id}" class="action-btn text-amber-600 hover:text-amber-800" title="Edit">
                            <i class="fas fa-edit"></i>
                        </a>
                        <button type="button" class="action-btn text-red-600 hover:text-red-800 btn-hapus" 
                            data-id="${id}" data-type="bidang" title="Hapus">
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-lg font-medium mb-1">Tidak ada bidang</p>
                                <p class="text-sm text-gray-400">Belum ada data bidang yang tersedia</p>
                            </div>
                        </td>
                    </tr>
                `;
                ...
                function renderBidangTable() {
                    ...
                    $(".page-btn-bidang").off("click").on("click", function() {
                ...
                function loadBidang() {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            console.error('Error loading bidang data:', status, error);
                            Swal.fire({
                                icon: 'error',
                                title: 'Gagal!',
