                    ...
                    <div class="p-6 text-white">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-purple-100 text-sm">Detail bidang lomba</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-medium">Bidang Lomba</span>
                            </div>
                ...
                <div class="bg-white rounded-lg shadow-md border border-gray-100 overflow-hidden mb-6">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-start gap-6 mb-8">
                            <div
                                class="w-24 h-24 rounded-xl bg-gradient-to-br from-green-100 to-emerald-100 flex items-center justify-center border-4 border-gray-200 shadow-lg flex-shrink-0">
                            ...
                            <div class="flex-1">
                                <h3 class="text-2xl font-bold text-gray-900 mb-2">{{ $bidang->nama }}</h3>
                                ...
                                <p class="text-gray-600">Bidang kompetisi untuk kategorisasi lomba dan prestasi mahasiswa
                                </p>
                            </div>
                        </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="bg-white rounded-lg p-4 border border-gray-200">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p class="text-xs text-gray-500 font-medium">Nama Bidang</p>
                                                <p class="text-sm font-semibold text-gray-900">{{ $bidang->nama }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-white rounded-lg p-4 border border-gray-200">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p class="text-xs text-gray-500 font-medium">Kode Bidang</p>
                    ...
                    <div class="p-6">
                        <div class="space-y-3">
                            <a href="{{ url("admin/bidang/edit/{$bidang->id}") }}"
                                ...
                                <div>
                                    <h5 class="font-medium text-gray-800">Edit Bidang</h5>
                                    <p class="text-sm text-gray-500">Update informasi bidang</p>
                                </div>
                            </a>
                    ...
                    <div class="p-5">
                        <div class="space-y-4 text-sm">
                            <div class="bg-green-50 border-l-4 border-green-400 p-3 rounded-r">
                                <h5 class="font-medium text-green-800 mb-1">Bidang Lomba</h5>
                                <p class="text-green-700">Bidang digunakan untuk mengkategorikan lomba berdasarkan area
                                    kompetisi atau keahlian.</p>
                            </div>
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <ul class="text-gray-600 text-xs mt-1 space-y-1">
                                        <li>• Kategorisasi lomba berdasarkan bidang</li>
                                        <li>• Filter pencarian lomba</li>
                                        <li>• Klasifikasi prestasi mahasiswa</li>
                                        <li>• Statistik prestasi per bidang</li>
                                    </ul>
                                </div>

                                <div>
                                    <h6 class="font-medium text-gray-800">Contoh Bidang</h6>
                                    <ul class="text-gray-600 text-xs mt-1 space-y-1">
